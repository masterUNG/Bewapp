...
String urlSche = "http://klogic.kmutnb.ac.th:8080/kris/tess/dataQuerySelector.jsp?query=studentTab";
...
class HomePage extends StatefulWidget {
  ...
  @override
  HomePagetState createState() => new HomePagetState(userId == null ? '0' : userId,type);
                        ...
                        child: Column(
                          children:<Widget>[
                            FlatButton(onPressed: () {
                              Navigator.of(context)
                                  .push(MaterialPageRoute<Null>(builder: (BuildContext context) {
                                return new WebViewScreen(urlString :  urlSche);
                              }));
